      ...
      <CssToolbarStyle
        ...
        <div className="fontSizes">
          <h3 className="h4">Font Size:</h3>
            <div>
              ...
              <input onChange={(e)=>updatePragraphSize(e)} className="spec-sheets__search__input" type="number" id="paragraph" name="paragraph" />
            </div>

            <div>
              <label htmlFor="h1">H1:</label>
              <input onChange={(e)=>updateH1Size(e)} className="spec-sheets__search__input" type="number" id="h1" name="h1" />
            </div>

            <div>
              <label htmlFor="h2">H2:</label>
              <input onChange={(e)=>updateH2Size(e)} className="spec-sheets__search__input" type="number" id="h2" name="h2" />
            </div>

            <div>
              <label htmlFor="h3">H3:</label>
              <input onChange={(e)=>updateH3Size(e)} className="spec-sheets__search__input" type="number" id="h3" name="h3" />
            </div>
                    
            <div>
              <label htmlFor="h4">H4:</label>
              <input onChange={(e)=>updateH4Size(e)} className="spec-sheets__search__input" type="number" id="h4" name="h4" />
            </div>
                    
            <div>
              <label htmlFor="h5">H5:</label>
              <input onChange={(e)=>updateH5Size(e)} className="spec-sheets__search__input" type="number" id="h5" name="h5" />
            </div>
                    
            <div>
              <label htmlFor="h6">H6:</label>
              <input onChange={(e)=>updateH6Size(e)} className="spec-sheets__search__input" type="number" id="h6" name="h6" />
              </div>
              
            <div>
              <label htmlFor="caption">Caption:</label>
              <input onChange={(e)=>updateCaptionSize(e)} className="spec-sheets__search__input" type="number" id="caption" name="caption" />
            </div>
          </div>
          ...
          <div className="fontFamilies">
            ...
            <div>
              ...
              <input onChange={(e)=>updateParagraphFontFamily(e)} className="spec-sheets__search__input" type="text" id="pFontFamily" name="pFontFamily" />
            </div>
            <div>
              <label htmlFor="headerFontFamily">Header:</label>
              <input onChange={(e)=>updateHeaderFontFamily(e)} className="spec-sheets__search__input" type="text" id="headerFontFamily" name="headerFontFamily" />
            </div>
          </div>  
        ...
        <div className="fontWeights">
          <h3 className="h4">Font Weights:</h3>
            <div>
              <label htmlFor="paragraph">Paragraph:</label>
              <input onChange={(e)=>updatePragraphWeight(e)} className="spec-sheets__search__input" type="number" id="paragraph" name="paragraph" />
            </div>

            <div>
              <label htmlFor="h1">H1:</label>
              <input onChange={(e)=>updateH1Weight(e)} className="spec-sheets__search__input" type="number" id="h1" name="h1" />
            </div>

            <div>
              <label htmlFor="h2">H2:</label>
              <input onChange={(e)=>updateH2Weight(e)} className="spec-sheets__search__input" type="number" id="h2" name="h2" />
            </div>

            <div>
              <label htmlFor="h3">H3:</label>
              <input onChange={(e)=>updateH3Weight(e)} className="spec-sheets__search__input" type="number" id="h3" name="h3" />
            </div>
                    
            <div>
              <label htmlFor="h4">H4:</label>
              <input onChange={(e)=>updateH4Weight(e)} className="spec-sheets__search__input" type="number" id="h4" name="h4" />
            </div>
                    
            <div>
              <label htmlFor="h5">H5:</label>
              <input onChange={(e)=>updateH5Weight(e)} className="spec-sheets__search__input" type="number" id="h5" name="h5" />
            </div>
                    
            <div>
              <label htmlFor="h6">H6:</label>
              <input onChange={(e)=>updateH6Weight(e)} className="spec-sheets__search__input" type="number" id="h6" name="h6" />
              </div>
              
            <div>
              <label htmlFor="caption">Caption:</label>
              <input onChange={(e)=>updateCaptionWeight(e)} className="spec-sheets__search__input" type="number" id="caption" name="caption" />
            </div>
          </div>
          ...
          <div className="colors">
            ...
            <div>
              ...
              <input onChange={(e)=>updateForegroundColor(e)} className="spec-sheets__search__input" type="text" id="foregroundColor" name="foregroundColor" />
            </div>
            <div>
              <label htmlFor="backgroundColor">Background:</label>
              <input onChange={(e)=>updateBackgroundColor(e)} className="spec-sheets__search__input" type="text" id="backgroundColor" name="backgroundColor" />
            </div>
              
            <div>
              <label htmlFor="accentColor">Accent:</label>
              <input onChange={(e)=>updateAccentColor(e)} className="spec-sheets__search__input" type="text" id="accentColor" name="accentColor" />
            </div>

            <div>
              <label htmlFor="placeholderColor">Placeholder:</label>
              <input onChange={(e)=>updatePlaceholderColor(e)} className="spec-sheets__search__input" type="text" id="placeholderColor" name="placeholderColor" />
            </div>
          </div>
        </CssToolbarStyle>
        </>
